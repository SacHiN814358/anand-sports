...
export function BrandStrip() {
  return (
    <section className="w-full bg-surface-dim py-20 border-b border-border-subtle overflow-hidden" id="brands">
        ...
        <Reveal variant="left">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-14">
            <div>
              ...
              <h2 className="font-display font-bold text-[30px] sm:text-[40px] uppercase tracking-tight text-white leading-tight">
                Our Partners
              </h2>
            </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
          {partners.map((b, i) => (
            <Reveal key={b.name} delay={i * 80} variant="scale">
              <div className="group relative p-5 rounded-2xl bg-white/[0.02] hover:bg-white/[0.05] border border-border-subtle hover:border-gold-accent/40 flex flex-col items-center justify-center text-center gap-1.5 transition-all duration-300 cursor-default">
                {b.highlight && (
                ...
                <span
                  className={`font-display font-bold text-[16px] uppercase tracking-widest group-hover:text-gold-light transition-colors ${
